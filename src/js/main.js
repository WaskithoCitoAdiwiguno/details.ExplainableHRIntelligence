(function () {
  ...
  var i18n = {
    id: {
      ...
      xai2: '<b>Risk tiering</b> — berbasis persentil (Rendah · Sedang · Tinggi), bukan ambang absolut — adil pada data tidak seimbang (Pavithran & Vadivel, 2026)',
      ...
      xai5: '<b>Preskriptif</b> — modul simulasi what-if: ubah faktor (mis. lembur) dan lihat dampaknya terhadap risiko sebelum keputusan diambil',
    ...
    en: {
      ...
      lede: 'An explainable human capital analytics framework: a calibrated Logistic Regression model estimates the chance an employee resigns, SHAP reveals the "why" feature by feature, and an LLM (Llama 3.3 via Groq) turns those numbers into tier-matched HR narratives and retention recommendations — with a what-if simulation for prescriptive analytics.',
      btnCode: 'Repo & Notebook',
      btnHow: 'How It Works',
      ...
      xai2: '<b>Risk tiering</b> — percentile-based (Low · Medium · High), not absolute thresholds — fair on imbalanced data (Pavithran & Vadivel, 2026)',
      ...
      xai5: '<b>Prescriptive</b> — a what-if simulation module: tweak a factor (e.g. overtime) and see its risk impact before decisions are made',
